...
public class DvCodedTextRecord extends UDTRecordImpl<DvCodedTextRecord> implements Record6<String, CodePhraseRecord, String, CodePhraseRecord, CodePhraseRecord, String[]> {
    ...
    @Override
    public DvCodedTextRecord values(String value1, CodePhraseRecord value2, String value3, CodePhraseRecord value4, CodePhraseRecord value5, String[] value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DvCodedTextRecord(String value, CodePhraseRecord definingCode, String formatting, CodePhraseRecord language, CodePhraseRecord encoding, String[] termMapping) {
        super(DvCodedText.DV_CODED_TEXT);
