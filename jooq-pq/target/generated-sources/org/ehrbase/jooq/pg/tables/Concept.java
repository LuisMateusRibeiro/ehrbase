...
public class Concept extends TableImpl<ConceptRecord> {
     ...
     */
    public final TableField<ConceptRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.concept.conceptid</code>.
     */
    public final TableField<ConceptRecord, Integer> CONCEPTID = createField(DSL.name("conceptid"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>ehr.concept.language</code>.
     */
    public final TableField<ConceptRecord, String> LANGUAGE = createField(DSL.name("language"), SQLDataType.VARCHAR(5), this, "");

    /**
     * The column <code>ehr.concept.description</code>.
     */
    public final TableField<ConceptRecord, String> DESCRIPTION = createField(DSL.name("description"), SQLDataType.CLOB, this, "");
    ...
    private Concept(Name alias, Table<ConceptRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("openEHR common concepts (e.g. terminology) used in the system"), TableOptions.table());
    }
    ...
    public Language language() {
        if (_language == null)
            _language = new Language(this, Keys.CONCEPT__CONCEPT_LANGUAGE_FKEY);
    ...
    @Override
    public Concept as(Table<?> alias) {
        return new Concept(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Concept rename(Table<?> name) {
        return new Concept(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super UUID, ? super Integer, ? super String, ? super String, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super UUID, ? super Integer, ? super String, ? super String, ? extends U> from) {
