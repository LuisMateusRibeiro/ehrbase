...
public class Ehr extends TableImpl<EhrRecord> {
     ...
     */
    public final TableField<EhrRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.ehr.date_created</code>.
     */
    public final TableField<EhrRecord, Timestamp> DATE_CREATED = createField(DSL.name("date_created"), SQLDataType.TIMESTAMP(6).defaultValue(DSL.field(DSL.raw("CURRENT_DATE"), SQLDataType.TIMESTAMP)), this, "");

    /**
     * The column <code>ehr.ehr.date_created_tzid</code>.
     */
    public final TableField<EhrRecord, String> DATE_CREATED_TZID = createField(DSL.name("date_created_tzid"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<EhrRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public Access access() {
        if (_access == null)
            _access = new Access(this, Keys.EHR__EHR_ACCESS_FKEY);
    ...
    public System system() {
        if (_system == null)
            _system = new System(this, Keys.EHR__EHR_SYSTEM_ID_FKEY);
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.EHR__EHR_SYS_TENANT_FKEY);
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super UUID, ? super Timestamp, ? super String, ? super UUID, ? super UUID, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super UUID, ? super Timestamp, ? super String, ? super UUID, ? super UUID, ? super Short, ? extends U> from) {
