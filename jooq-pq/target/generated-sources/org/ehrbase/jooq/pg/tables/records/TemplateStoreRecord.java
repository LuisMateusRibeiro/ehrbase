...
public class TemplateStoreRecord extends UpdatableRecordImpl<TemplateStoreRecord> implements Record5<UUID, String, String, Timestamp, Short> {
    ...
    /**
     * Setter for <code>ehr.template_store.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.template_store.sys_tenant</code>.
     */
    ...
    @Override
    public Record3<UUID, String, Short> key() {
    ...
    @Override
    public Row5<UUID, String, String, Timestamp, Short> valuesRow() {
    ...
    public Field<Short> field5() {
        return TemplateStore.TEMPLATE_STORE.SYS_TENANT;
    }
    ...
    @Override
    public TemplateStoreRecord value5(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public TemplateStoreRecord values(UUID value1, String value2, String value3, Timestamp value4, Short value5) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TemplateStoreRecord(UUID id, String templateId, String content, Timestamp sysTransaction, Short sysTenant) {
        super(TemplateStore.TEMPLATE_STORE);
