...
public class System extends TableImpl<SystemRecord> {
     ...
     */
    public final TableField<SystemRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");
    ...
    @Override
    public System as(Table<?> alias) {
        return new System(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public System rename(Table<?> name) {
        return new System(name.getQualifiedName(), null);
    }
