...
public class IdentifierRecord extends TableRecordImpl<IdentifierRecord> implements Record6<String, String, String, String, UUID, Short> {
    ...
    @Override
    public IdentifierRecord values(String value1, String value2, String value3, String value4, UUID value5, Short value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public IdentifierRecord(String idValue, String issuer, String assigner, String typeName, UUID party, Short sysTenant) {
        super(Identifier.IDENTIFIER);
