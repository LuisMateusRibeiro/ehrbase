...
public class AdminDeleteAudit extends TableImpl<AdminDeleteAuditRecord> {
     ...
     */
    public final TableField<AdminDeleteAuditRecord, Integer> NUM = createField(DSL.name("num"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>ehr.admin_delete_audit.party</code>.
     */
    public final TableField<AdminDeleteAuditRecord, UUID> PARTY = createField(DSL.name("party"), SQLDataType.UUID, this, "");
    ...
    @Override
    public AdminDeleteAudit as(Table<?> alias) {
        return new AdminDeleteAudit(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteAudit rename(Table<?> name) {
        return new AdminDeleteAudit(name.getQualifiedName(), null, parameters);
    }
     ...
     */
    public AdminDeleteAudit call(
          UUID auditInput
    ) {
        AdminDeleteAudit result = new AdminDeleteAudit(DSL.name("admin_delete_audit"), null, new Field[] {
            DSL.val(auditInput, SQLDataType.UUID)
        });
