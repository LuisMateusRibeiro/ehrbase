...
public class EntryHistoryRecord extends TableRecordImpl<EntryHistoryRecord> implements Record14<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, String, DvCodedTextRecord, Short> {
    ...
    /**
     * Setter for <code>ehr.entry_history.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.entry_history.sys_tenant</code>.
     */
    ...
    @Override
    public Row14<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, String, DvCodedTextRecord, Short> valuesRow() {
    ...
    public Field<Short> field14() {
        return EntryHistory.ENTRY_HISTORY.SYS_TENANT;
    }
    ...
    @Override
    public EntryHistoryRecord value14(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public EntryHistoryRecord values(UUID value1, UUID value2, Integer value3, EntryType value4, String value5, UUID value6, String value7, DvCodedTextRecord value8, JSONB value9, Timestamp value10, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value11, String value12, DvCodedTextRecord value13, Short value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public EntryHistoryRecord(UUID id, UUID compositionId, Integer sequence, EntryType itemType, String templateId, UUID templateUuid, String archetypeId, DvCodedTextRecord category, JSONB entry, Timestamp sysTransaction, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> sysPeriod, String rmVersion, DvCodedTextRecord name, Short sysTenant) {
        super(EntryHistory.ENTRY_HISTORY);
