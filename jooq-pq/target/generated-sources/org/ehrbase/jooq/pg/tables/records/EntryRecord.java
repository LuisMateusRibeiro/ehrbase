...
public class EntryRecord extends UpdatableRecordImpl<EntryRecord> implements Record14<UUID, UUID, Integer, EntryType, String, UUID, String, DvCodedTextRecord, JSONB, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, String, DvCodedTextRecord, Short> {
