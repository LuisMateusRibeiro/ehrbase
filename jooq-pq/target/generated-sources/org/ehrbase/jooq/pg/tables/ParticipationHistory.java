...
public class ParticipationHistory extends TableImpl<ParticipationHistoryRecord> {
     ...
     */
    public final TableField<ParticipationHistoryRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.participation_history.event_context</code>.
     */
    public final TableField<ParticipationHistoryRecord, UUID> EVENT_CONTEXT = createField(DSL.name("event_context"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.participation_history.performer</code>.
     */
    public final TableField<ParticipationHistoryRecord, UUID> PERFORMER = createField(DSL.name("performer"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.participation_history.function</code>.
     */
    public final TableField<ParticipationHistoryRecord, DvCodedTextRecord> FUNCTION = createField(DSL.name("function"), org.ehrbase.jooq.pg.udt.DvCodedText.DV_CODED_TEXT.getDataType(), this, "");

    /**
     * The column <code>ehr.participation_history.mode</code>.
     */
    public final TableField<ParticipationHistoryRecord, DvCodedTextRecord> MODE = createField(DSL.name("mode"), org.ehrbase.jooq.pg.udt.DvCodedText.DV_CODED_TEXT.getDataType(), this, "");

    /**
     * The column <code>ehr.participation_history.time_lower</code>.
     */
    public final TableField<ParticipationHistoryRecord, Timestamp> TIME_LOWER = createField(DSL.name("time_lower"), SQLDataType.TIMESTAMP(6), this, "");

    /**
     * The column <code>ehr.participation_history.time_lower_tz</code>.
     */
    public final TableField<ParticipationHistoryRecord, String> TIME_LOWER_TZ = createField(DSL.name("time_lower_tz"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.participation_history.sys_transaction</code>.
     */
    public final TableField<ParticipationHistoryRecord, Timestamp> SYS_TRANSACTION = createField(DSL.name("sys_transaction"), SQLDataType.TIMESTAMP(6).nullable(false), this, "");

    /**
     * The column <code>ehr.participation_history.sys_period</code>.
     */
    public final TableField<ParticipationHistoryRecord, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> SYS_PERIOD = createField(DSL.name("sys_period"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tstzrange\"").nullable(false), this, "", new SysPeriodBinder());

    /**
     * The column <code>ehr.participation_history.time_upper</code>.
     */
    public final TableField<ParticipationHistoryRecord, Timestamp> TIME_UPPER = createField(DSL.name("time_upper"), SQLDataType.TIMESTAMP(6), this, "");

    /**
     * The column <code>ehr.participation_history.time_upper_tz</code>.
     */
    public final TableField<ParticipationHistoryRecord, String> TIME_UPPER_TZ = createField(DSL.name("time_upper_tz"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.participation_history.sys_tenant</code>.
     */
    public final TableField<ParticipationHistoryRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    @Override
    public Row12<UUID, UUID, UUID, DvCodedTextRecord, DvCodedTextRecord, Timestamp, String, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, Timestamp, String, Short> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function12<? super UUID, ? super UUID, ? super UUID, ? super DvCodedTextRecord, ? super DvCodedTextRecord, ? super Timestamp, ? super String, ? super Timestamp, ? super SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, ? super Timestamp, ? super String, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function12<? super UUID, ? super UUID, ? super UUID, ? super DvCodedTextRecord, ? super DvCodedTextRecord, ? super Timestamp, ? super String, ? super Timestamp, ? super SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, ? super Timestamp, ? super String, ? super Short, ? extends U> from) {
