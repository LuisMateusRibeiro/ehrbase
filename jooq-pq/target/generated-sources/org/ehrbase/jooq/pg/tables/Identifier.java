...
public class Identifier extends TableImpl<IdentifierRecord> {
     ...
     */
    public final TableField<IdentifierRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.IDENTIFIER__IDENTIFIER_SYS_TENANT_FKEY);
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super String, ? super String, ? super String, ? super String, ? super UUID, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function6<? super String, ? super String, ? super String, ? super String, ? super UUID, ? super Short, ? extends U> from) {
