...
public class Plugin extends TableImpl<PluginRecord> {
     ...
     */
    public final TableField<PluginRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.plugin.pluginid</code>.
     */
    public final TableField<PluginRecord, String> PLUGINID = createField(DSL.name("pluginid"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.plugin.key</code>.
     */
    public final TableField<PluginRecord, String> KEY = createField(DSL.name("key"), SQLDataType.CLOB.nullable(false), this, "");
    ...
    private Plugin(Name alias, Table<PluginRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("key value store for plugin sub system"), TableOptions.table());
    }
