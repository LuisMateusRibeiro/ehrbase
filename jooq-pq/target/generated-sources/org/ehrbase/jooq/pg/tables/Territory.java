...
public class Territory extends TableImpl<TerritoryRecord> {
    ...
    @Override
    public Territory as(Table<?> alias) {
        return new Territory(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public Territory rename(Table<?> name) {
        return new Territory(name.getQualifiedName(), null);
    }
