...
public class PartyUsageIdentification extends TableImpl<PartyUsageIdentificationRecord> {
     ...
     */
    public final TableField<PartyUsageIdentificationRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.party_usage_identification.entity</code>.
     */
    public final TableField<PartyUsageIdentificationRecord, String> ENTITY = createField(DSL.name("entity"), SQLDataType.CLOB, this, "");
    ...
    @Override
    public PartyUsageIdentification as(Table<?> alias) {
        return new PartyUsageIdentification(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public PartyUsageIdentification rename(Table<?> name) {
        return new PartyUsageIdentification(name.getQualifiedName(), null, parameters);
    }
     ...
     */
    public PartyUsageIdentification call(
          UUID partyUuid
    ) {
        PartyUsageIdentification result = new PartyUsageIdentification(DSL.name("party_usage_identification"), null, new Field[] {
            DSL.val(partyUuid, SQLDataType.UUID)
        });
