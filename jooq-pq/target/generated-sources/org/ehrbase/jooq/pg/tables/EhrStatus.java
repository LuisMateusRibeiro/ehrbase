...
import org.ehrbase.jooq.pg.tables.records.EhrStatusRecord;
...
public class EhrStatus extends TableImpl<EhrStatusRecord> {
     ...
     */
    public final TableField<EhrStatusRecord, String> SCHEME = createField(DSL.name("scheme"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.ehr_status.namespace</code>.
     */
    public final TableField<EhrStatusRecord, String> NAMESPACE = createField(DSL.name("namespace"), SQLDataType.CLOB, this, "");
     ...
     */
    public final TableField<EhrStatusRecord, String> ID_VALUE = createField(DSL.name("id_value"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.ehr_status.issuer</code>.
     */
    public final TableField<EhrStatusRecord, String> ISSUER = createField(DSL.name("issuer"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.ehr_status.assigner</code>.
     */
    public final TableField<EhrStatusRecord, String> ASSIGNER = createField(DSL.name("assigner"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.ehr_status.type_name</code>.
     */
    public final TableField<EhrStatusRecord, String> TYPE_NAME = createField(DSL.name("type_name"), SQLDataType.CLOB, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function11<? super UUID, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UUID, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function11<? super UUID, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super String, ? super UUID, ? extends U> from) {
