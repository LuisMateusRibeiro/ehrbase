...
public class AttestationRecord extends UpdatableRecordImpl<AttestationRecord> implements Record7<UUID, String, String, Boolean, UUID, UUID, Short> {
    ...
    @Override
    public AttestationRecord values(UUID value1, String value2, String value3, Boolean value4, UUID value5, UUID value6, Short value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AttestationRecord(UUID id, String proof, String reason, Boolean isPending, UUID hasAudit, UUID reference, Short sysTenant) {
        super(Attestation.ATTESTATION);
