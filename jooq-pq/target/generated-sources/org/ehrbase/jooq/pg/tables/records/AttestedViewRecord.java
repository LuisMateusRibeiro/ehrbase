...
public class AttestedViewRecord extends UpdatableRecordImpl<AttestedViewRecord> implements Record11<UUID, UUID, String, String, String, byte[], byte[], String, UUID, String, Short> {
    ...
    /**
     * Setter for <code>ehr.attested_view.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.attested_view.sys_tenant</code>.
     */
    ...
    @Override
    public Row11<UUID, UUID, String, String, String, byte[], byte[], String, UUID, String, Short> valuesRow() {
    ...
    public Field<Short> field11() {
        return AttestedView.ATTESTED_VIEW.SYS_TENANT;
    }
    ...
    @Override
    public AttestedViewRecord value11(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public AttestedViewRecord values(UUID value1, UUID value2, String value3, String value4, String value5, byte[] value6, byte[] value7, String value8, UUID value9, String value10, Short value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AttestedViewRecord(UUID id, UUID attestationId, String alternateText, String compressionAlgorithm, String mediaType, byte[] data, byte[] integrityCheck, String integrityCheckAlgorithm, UUID thumbnail, String uri, Short sysTenant) {
        super(AttestedView.ATTESTED_VIEW);
