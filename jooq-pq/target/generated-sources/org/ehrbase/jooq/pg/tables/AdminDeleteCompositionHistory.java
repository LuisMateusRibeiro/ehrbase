...
public class AdminDeleteCompositionHistory extends TableImpl<AdminDeleteCompositionHistoryRecord> {
    ...
    @Override
    public AdminDeleteCompositionHistory as(Table<?> alias) {
        return new AdminDeleteCompositionHistory(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteCompositionHistory rename(Table<?> name) {
        return new AdminDeleteCompositionHistory(name.getQualifiedName(), null, parameters);
    }
