...
public class ContributionRecord extends UpdatableRecordImpl<ContributionRecord> implements Record7<UUID, UUID, ContributionDataType, ContributionState, String, UUID, Short> {
    ...
    @Override
    public ContributionRecord values(UUID value1, UUID value2, ContributionDataType value3, ContributionState value4, String value5, UUID value6, Short value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ContributionRecord(UUID id, UUID ehrId, ContributionDataType contributionType, ContributionState state, String signature, UUID hasAudit, Short sysTenant) {
        super(Contribution.CONTRIBUTION);
