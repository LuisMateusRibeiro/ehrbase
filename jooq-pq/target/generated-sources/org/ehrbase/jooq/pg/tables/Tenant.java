...
public class Tenant extends TableImpl<TenantRecord> {
     ...
     */
    public final TableField<TenantRecord, String> TENANT_ID = createField(DSL.name("tenant_id"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.tenant.tenant_name</code>.
     */
    public final TableField<TenantRecord, String> TENANT_NAME = createField(DSL.name("tenant_name"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.tenant.tenant_properties</code>.
     */
    public final TableField<TenantRecord, JSON> TENANT_PROPERTIES = createField(DSL.name("tenant_properties"), SQLDataType.JSON, this, "");

    /**
     * The column <code>ehr.tenant.id</code>.
     */
    public final TableField<TenantRecord, Short> ID = createField(DSL.name("id"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("ehr.next_sys_tenant()"), SQLDataType.SMALLINT)), this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super String, ? super String, ? super JSON, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super String, ? super String, ? super JSON, ? super Short, ? extends U> from) {
