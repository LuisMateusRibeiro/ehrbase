...
public class AdminDeleteEhr extends TableImpl<AdminDeleteEhrRecord> {
     ...
     */
    public final TableField<AdminDeleteEhrRecord, Integer> NUM = createField(DSL.name("num"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>ehr.admin_delete_ehr.status_audit</code>.
     */
    public final TableField<AdminDeleteEhrRecord, UUID> STATUS_AUDIT = createField(DSL.name("status_audit"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.admin_delete_ehr.status_party</code>.
     */
    public final TableField<AdminDeleteEhrRecord, UUID> STATUS_PARTY = createField(DSL.name("status_party"), SQLDataType.UUID, this, "");
    ...
    @Override
    public AdminDeleteEhr as(Table<?> alias) {
        return new AdminDeleteEhr(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteEhr rename(Table<?> name) {
        return new AdminDeleteEhr(name.getQualifiedName(), null, parameters);
    }
     ...
     */
    public AdminDeleteEhr call(
          UUID ehrIdInput
    ) {
        AdminDeleteEhr result = new AdminDeleteEhr(DSL.name("admin_delete_ehr"), null, new Field[] {
