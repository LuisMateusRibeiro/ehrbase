...
public class AdminDeleteAttestation extends TableImpl<AdminDeleteAttestationRecord> {
    ...
    @Override
    public AdminDeleteAttestation as(Table<?> alias) {
        return new AdminDeleteAttestation(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteAttestation rename(Table<?> name) {
        return new AdminDeleteAttestation(name.getQualifiedName(), null, parameters);
    }
