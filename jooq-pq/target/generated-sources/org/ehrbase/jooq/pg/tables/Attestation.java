...
public class Attestation extends TableImpl<AttestationRecord> {
     ...
     */
    public final TableField<AttestationRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.attestation.proof</code>.
     */
    public final TableField<AttestationRecord, String> PROOF = createField(DSL.name("proof"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.attestation.reason</code>.
     */
    public final TableField<AttestationRecord, String> REASON = createField(DSL.name("reason"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.attestation.is_pending</code>.
     */
    public final TableField<AttestationRecord, Boolean> IS_PENDING = createField(DSL.name("is_pending"), SQLDataType.BOOLEAN, this, "");

    /**
     * The column <code>ehr.attestation.has_audit</code>.
     */
    public final TableField<AttestationRecord, UUID> HAS_AUDIT = createField(DSL.name("has_audit"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.attestation.reference</code>.
     */
    public final TableField<AttestationRecord, UUID> REFERENCE = createField(DSL.name("reference"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.attestation.sys_tenant</code>.
     */
    public final TableField<AttestationRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public List<ForeignKey<AttestationRecord, ?>> getReferences() {
        return Arrays.asList(Keys.ATTESTATION__ATTESTATION_HAS_AUDIT_FKEY, Keys.ATTESTATION__ATTESTATION_REFERENCE_FKEY, Keys.ATTESTATION__ATTESTATION_SYS_TENANT_FKEY);
    }
    ...
    public AuditDetails auditDetails() {
        if (_auditDetails == null)
            _auditDetails = new AuditDetails(this, Keys.ATTESTATION__ATTESTATION_HAS_AUDIT_FKEY);
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.ATTESTATION__ATTESTATION_SYS_TENANT_FKEY);
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super UUID, ? super String, ? super String, ? super Boolean, ? super UUID, ? super UUID, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super UUID, ? super String, ? super String, ? super Boolean, ? super UUID, ? super UUID, ? super Short, ? extends U> from) {
