...
public class EhrRecord extends UpdatableRecordImpl<EhrRecord> implements Record6<UUID, Timestamp, String, UUID, UUID, Short> {
     ...
     */
    public EhrRecord(UUID id, Timestamp dateCreated, String dateCreatedTzid, UUID access, UUID systemId, Short sysTenant) {
        super(Ehr.EHR_);
