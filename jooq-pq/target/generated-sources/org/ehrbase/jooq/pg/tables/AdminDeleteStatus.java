...
public class AdminDeleteStatus extends TableImpl<AdminDeleteStatusRecord> {
    ...
    @Override
    public AdminDeleteStatus as(Table<?> alias) {
        return new AdminDeleteStatus(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteStatus rename(Table<?> name) {
        return new AdminDeleteStatus(name.getQualifiedName(), null, parameters);
    }
