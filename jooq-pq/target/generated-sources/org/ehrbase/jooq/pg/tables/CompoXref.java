...
public class CompoXref extends TableImpl<CompoXrefRecord> {
    ...
    /**
     * The column <code>ehr.compo_xref.sys_tenant</code>.
     */
    public final TableField<CompoXrefRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public List<ForeignKey<CompoXrefRecord, ?>> getReferences() {
        return Arrays.asList(Keys.COMPO_XREF__COMPO_XREF_MASTER_UUID_FKEY, Keys.COMPO_XREF__COMPO_XREF_CHILD_UUID_FKEY, Keys.COMPO_XREF__COMPO_XREF_SYS_TENANT_FKEY);
    }
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.COMPO_XREF__COMPO_XREF_SYS_TENANT_FKEY);
    ...
    @Override
    public CompoXref as(Table<?> alias) {
        return new CompoXref(alias.getQualifiedName(), this);
    }
     ...
     */
    @Override
    public CompoXref rename(Table<?> name) {
        return new CompoXref(name.getQualifiedName(), null);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super UUID, ? super UUID, ? super Timestamp, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super UUID, ? super UUID, ? super Timestamp, ? super Short, ? extends U> from) {
