...
public class AdminGetLinkedCompositions extends TableImpl<AdminGetLinkedCompositionsRecord> {
    ...
    @Override
    public AdminGetLinkedCompositions as(Table<?> alias) {
        return new AdminGetLinkedCompositions(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminGetLinkedCompositions rename(Table<?> name) {
        return new AdminGetLinkedCompositions(name.getQualifiedName(), null, parameters);
    }
