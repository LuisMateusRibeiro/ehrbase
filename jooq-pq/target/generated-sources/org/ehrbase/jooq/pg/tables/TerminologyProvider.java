...
public class TerminologyProvider extends TableImpl<TerminologyProviderRecord> {
     ...
     */
    public final TableField<TerminologyProviderRecord, String> CODE = createField(DSL.name("code"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.terminology_provider.source</code>.
     */
    public final TableField<TerminologyProviderRecord, String> SOURCE = createField(DSL.name("source"), SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>ehr.terminology_provider.authority</code>.
     */
    public final TableField<TerminologyProviderRecord, String> AUTHORITY = createField(DSL.name("authority"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.terminology_provider.sys_tenant</code>.
     */
    public final TableField<TerminologyProviderRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    private TerminologyProvider(Name alias, Table<TerminologyProviderRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("openEHR identified terminology provider"), TableOptions.table());
    }
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super String, ? super String, ? super String, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super String, ? super String, ? super String, ? super Short, ? extends U> from) {
