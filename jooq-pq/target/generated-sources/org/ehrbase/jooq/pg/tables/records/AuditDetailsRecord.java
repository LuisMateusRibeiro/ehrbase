...
public class AuditDetailsRecord extends UpdatableRecordImpl<AuditDetailsRecord> implements Record8<UUID, UUID, UUID, Timestamp, String, ContributionChangeType, String, Short> {
    ...
    /**
     * Setter for <code>ehr.audit_details.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.audit_details.sys_tenant</code>.
     */
    ...
    @Override
    public Row8<UUID, UUID, UUID, Timestamp, String, ContributionChangeType, String, Short> valuesRow() {
    ...
    public Field<Short> field8() {
        return AuditDetails.AUDIT_DETAILS.SYS_TENANT;
    }
    ...
    @Override
    public AuditDetailsRecord value8(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public AuditDetailsRecord values(UUID value1, UUID value2, UUID value3, Timestamp value4, String value5, ContributionChangeType value6, String value7, Short value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public AuditDetailsRecord(UUID id, UUID systemId, UUID committer, Timestamp timeCommitted, String timeCommittedTzid, ContributionChangeType changeType, String description, Short sysTenant) {
        super(AuditDetails.AUDIT_DETAILS);
