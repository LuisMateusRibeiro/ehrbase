...
public class StatusRecord extends UpdatableRecordImpl<StatusRecord> implements Record14<UUID, UUID, Boolean, Boolean, UUID, ItemStructure, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, UUID, UUID, UUID, String, DvCodedTextRecord, Short> {
    ...
    /**
     * Setter for <code>ehr.status.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.status.sys_tenant</code>.
     */
    ...
    public Field<Short> field14() {
        return Status.STATUS.SYS_TENANT;
    }
    ...
    @Override
    public StatusRecord value14(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public StatusRecord values(UUID value1, UUID value2, Boolean value3, Boolean value4, UUID value5, ItemStructure value6, Timestamp value7, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime> value8, UUID value9, UUID value10, UUID value11, String value12, DvCodedTextRecord value13, Short value14) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
