...
public class Heading extends TableImpl<HeadingRecord> {
     ...
     */
    public final TableField<HeadingRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.HEADING__HEADING_SYS_TENANT_FKEY);
