...
public class AdminDeleteComposition extends TableImpl<AdminDeleteCompositionRecord> {
    ...
    @Override
    public AdminDeleteComposition as(Table<?> alias) {
        return new AdminDeleteComposition(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminDeleteComposition rename(Table<?> name) {
        return new AdminDeleteComposition(name.getQualifiedName(), null, parameters);
    }
     ...
     */
    public <U> SelectField<U> mapping(Function5<? super Integer, ? super UUID, ? super UUID, ? super UUID, ? super UUID, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function5<? super Integer, ? super UUID, ? super UUID, ? super UUID, ? super UUID, ? extends U> from) {
