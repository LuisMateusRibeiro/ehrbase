...
public class PartyIdentifiedRecord extends UpdatableRecordImpl<PartyIdentifiedRecord> implements Record10<UUID, String, String, String, String, String, PartyType, DvCodedTextRecord, PartyRefIdType, Short> {
    ...
    /**
     * Setter for <code>ehr.party_identified.sys_tenant</code>.
     */
    ...
    /**
     * Getter for <code>ehr.party_identified.sys_tenant</code>.
     */
    ...
    @Override
    public Row10<UUID, String, String, String, String, String, PartyType, DvCodedTextRecord, PartyRefIdType, Short> valuesRow() {
    ...
    public Field<Short> field10() {
        return PartyIdentified.PARTY_IDENTIFIED.SYS_TENANT;
    }
    ...
    @Override
    public PartyIdentifiedRecord value10(Short value) {
        setSysTenant(value);
        return this;
    }

    @Override
    public PartyIdentifiedRecord values(UUID value1, String value2, String value3, String value4, String value5, String value6, PartyType value7, DvCodedTextRecord value8, PartyRefIdType value9, Short value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public PartyIdentifiedRecord(UUID id, String name, String partyRefValue, String partyRefScheme, String partyRefNamespace, String partyRefType, PartyType partyType, DvCodedTextRecord relationship, PartyRefIdType objectIdType, Short sysTenant) {
        super(PartyIdentified.PARTY_IDENTIFIED);
