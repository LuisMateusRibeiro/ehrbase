...
public class Composition extends TableImpl<CompositionRecord> {
     ...
     */
    public final TableField<CompositionRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.composition.ehr_id</code>.
     */
    public final TableField<CompositionRecord, UUID> EHR_ID = createField(DSL.name("ehr_id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.composition.in_contribution</code>.
     */
    public final TableField<CompositionRecord, UUID> IN_CONTRIBUTION = createField(DSL.name("in_contribution"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.composition.active</code>.
     */
    public final TableField<CompositionRecord, Boolean> ACTIVE = createField(DSL.name("active"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("true"), SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>ehr.composition.is_persistent</code>.
     */
    public final TableField<CompositionRecord, Boolean> IS_PERSISTENT = createField(DSL.name("is_persistent"), SQLDataType.BOOLEAN.defaultValue(DSL.field(DSL.raw("true"), SQLDataType.BOOLEAN)), this, "");

    /**
     * The column <code>ehr.composition.language</code>.
     */
    public final TableField<CompositionRecord, String> LANGUAGE = createField(DSL.name("language"), SQLDataType.VARCHAR(5), this, "");

    /**
     * The column <code>ehr.composition.territory</code>.
     */
    public final TableField<CompositionRecord, Integer> TERRITORY = createField(DSL.name("territory"), SQLDataType.INTEGER, this, "");

    /**
     * The column <code>ehr.composition.composer</code>.
     */
    public final TableField<CompositionRecord, UUID> COMPOSER = createField(DSL.name("composer"), SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>ehr.composition.sys_transaction</code>.
     */
    public final TableField<CompositionRecord, Timestamp> SYS_TRANSACTION = createField(DSL.name("sys_transaction"), SQLDataType.TIMESTAMP(6).nullable(false), this, "");

    /**
     * The column <code>ehr.composition.sys_period</code>.
     */
    public final TableField<CompositionRecord, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>> SYS_PERIOD = createField(DSL.name("sys_period"), org.jooq.impl.DefaultDataType.getDefaultDataType("\"pg_catalog\".\"tstzrange\"").nullable(false), this, "", new SysPeriodBinder());

    /**
     * The column <code>ehr.composition.has_audit</code>.
     */
    public final TableField<CompositionRecord, UUID> HAS_AUDIT = createField(DSL.name("has_audit"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.composition.attestation_ref</code>.
     */
    public final TableField<CompositionRecord, UUID> ATTESTATION_REF = createField(DSL.name("attestation_ref"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.composition.feeder_audit</code>.
     */
    public final TableField<CompositionRecord, JSONB> FEEDER_AUDIT = createField(DSL.name("feeder_audit"), SQLDataType.JSONB, this, "");

    /**
     * The column <code>ehr.composition.links</code>.
     */
    public final TableField<CompositionRecord, JSONB> LINKS = createField(DSL.name("links"), SQLDataType.JSONB, this, "");

    /**
     * The column <code>ehr.composition.sys_tenant</code>.
     */
    public final TableField<CompositionRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public org.ehrbase.jooq.pg.tables.Ehr ehr() {
        if (_ehr == null)
            _ehr = new org.ehrbase.jooq.pg.tables.Ehr(this, Keys.COMPOSITION__COMPOSITION_EHR_ID_FKEY);
    ...
    public Language language() {
        if (_language == null)
            _language = new Language(this, Keys.COMPOSITION__COMPOSITION_LANGUAGE_FKEY);
    ...
    public Territory territory() {
        if (_territory == null)
            _territory = new Territory(this, Keys.COMPOSITION__COMPOSITION_TERRITORY_FKEY);
    ...
    public AuditDetails auditDetails() {
        if (_auditDetails == null)
            _auditDetails = new AuditDetails(this, Keys.COMPOSITION__COMPOSITION_HAS_AUDIT_FKEY);
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.COMPOSITION__COMPOSITION_SYS_TENANT_FKEY);
    ...
    @Override
    public Row15<UUID, UUID, UUID, Boolean, Boolean, String, Integer, UUID, Timestamp, SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, UUID, UUID, JSONB, JSONB, Short> fieldsRow() {
     ...
     */
    public <U> SelectField<U> mapping(Function15<? super UUID, ? super UUID, ? super UUID, ? super Boolean, ? super Boolean, ? super String, ? super Integer, ? super UUID, ? super Timestamp, ? super SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, ? super UUID, ? super UUID, ? super JSONB, ? super JSONB, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function15<? super UUID, ? super UUID, ? super UUID, ? super Boolean, ? super Boolean, ? super String, ? super Integer, ? super UUID, ? super Timestamp, ? super SimpleEntry<java.time.OffsetDateTime, java.time.OffsetDateTime>, ? super UUID, ? super UUID, ? super JSONB, ? super JSONB, ? super Short, ? extends U> from) {
