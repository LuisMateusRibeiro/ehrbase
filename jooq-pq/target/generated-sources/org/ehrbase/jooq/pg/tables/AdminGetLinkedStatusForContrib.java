...
public class AdminGetLinkedStatusForContrib extends TableImpl<AdminGetLinkedStatusForContribRecord> {
     ...
     */
    public final TableField<AdminGetLinkedStatusForContribRecord, UUID> STATUS = createField(DSL.name("status"), SQLDataType.UUID, this, "");
    ...
    @Override
    public AdminGetLinkedStatusForContrib as(Table<?> alias) {
        return new AdminGetLinkedStatusForContrib(alias.getQualifiedName(), this, parameters);
    }
     ...
     */
    @Override
    public AdminGetLinkedStatusForContrib rename(Table<?> name) {
        return new AdminGetLinkedStatusForContrib(name.getQualifiedName(), null, parameters);
    }
     ...
     */
    public AdminGetLinkedStatusForContrib call(
          UUID contribIdInput
    ) {
        AdminGetLinkedStatusForContrib result = new AdminGetLinkedStatusForContrib(DSL.name("admin_get_linked_status_for_contrib"), null, new Field[] {
