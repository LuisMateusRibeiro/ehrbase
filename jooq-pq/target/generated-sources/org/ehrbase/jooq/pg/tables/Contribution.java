...
public class Contribution extends TableImpl<ContributionRecord> {
     ...
     */
    public final TableField<ContributionRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");

    /**
     * The column <code>ehr.contribution.ehr_id</code>.
     */
    public final TableField<ContributionRecord, UUID> EHR_ID = createField(DSL.name("ehr_id"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.contribution.contribution_type</code>.
     */
    public final TableField<ContributionRecord, ContributionDataType> CONTRIBUTION_TYPE = createField(DSL.name("contribution_type"), SQLDataType.VARCHAR.asEnumDataType(org.ehrbase.jooq.pg.enums.ContributionDataType.class), this, "");

    /**
     * The column <code>ehr.contribution.state</code>.
     */
    public final TableField<ContributionRecord, ContributionState> STATE = createField(DSL.name("state"), SQLDataType.VARCHAR.asEnumDataType(org.ehrbase.jooq.pg.enums.ContributionState.class), this, "");

    /**
     * The column <code>ehr.contribution.signature</code>.
     */
    public final TableField<ContributionRecord, String> SIGNATURE = createField(DSL.name("signature"), SQLDataType.CLOB, this, "");

    /**
     * The column <code>ehr.contribution.has_audit</code>.
     */
    public final TableField<ContributionRecord, UUID> HAS_AUDIT = createField(DSL.name("has_audit"), SQLDataType.UUID, this, "");

    /**
     * The column <code>ehr.contribution.sys_tenant</code>.
     */
    public final TableField<ContributionRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    private Contribution(Name alias, Table<ContributionRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment("Contribution table, compositions reference this table"), TableOptions.table());
    }
    ...
    public org.ehrbase.jooq.pg.tables.Ehr ehr() {
        if (_ehr == null)
            _ehr = new org.ehrbase.jooq.pg.tables.Ehr(this, Keys.CONTRIBUTION__CONTRIBUTION_EHR_ID_FKEY);
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.CONTRIBUTION__CONTRIBUTION_SYS_TENANT_FKEY);
     ...
     */
    public <U> SelectField<U> mapping(Function7<? super UUID, ? super UUID, ? super ContributionDataType, ? super ContributionState, ? super String, ? super UUID, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function7<? super UUID, ? super UUID, ? super ContributionDataType, ? super ContributionState, ? super String, ? super UUID, ? super Short, ? extends U> from) {
