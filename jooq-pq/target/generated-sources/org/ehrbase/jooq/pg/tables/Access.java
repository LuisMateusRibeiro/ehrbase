...
public class Access extends TableImpl<AccessRecord> {
     ...
     */
    public final TableField<AccessRecord, UUID> ID = createField(DSL.name("id"), SQLDataType.UUID.nullable(false).defaultValue(DSL.field(DSL.raw("uuid_generate_v4()"), SQLDataType.UUID)), this, "");
     ...
     */
    public final TableField<AccessRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.nullable(false).defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
    ...
    public Tenant tenant() {
        if (_tenant == null)
            _tenant = new Tenant(this, Keys.ACCESS__ACCESS_SYS_TENANT_FKEY);
     ...
     */
    public <U> SelectField<U> mapping(Function4<? super UUID, ? super String, ? super String, ? super Short, ? extends U> from) {
     ...
     * Function)}.
     */
    public <U> SelectField<U> mapping(Class<U> toType, Function4<? super UUID, ? super String, ? super String, ? super Short, ? extends U> from) {
