...
public class EventContextHistory extends TableImpl<EventContextHistoryRecord> {
     ...
     */
    public final TableField<EventContextHistoryRecord, Short> SYS_TENANT = createField(DSL.name("sys_tenant"), SQLDataType.SMALLINT.defaultValue(DSL.field(DSL.raw("1"), SQLDataType.SMALLINT)), this, "");
