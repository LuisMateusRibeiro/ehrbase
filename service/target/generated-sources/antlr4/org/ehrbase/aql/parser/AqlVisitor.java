...
public interface AqlVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link AqlParser#castFunction}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitCastFunction(AqlParser.CastFunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link AqlParser#invokeOperand}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInvokeOperand(AqlParser.InvokeOperandContext ctx);
	/**
	 * Visit a parse tree produced by {@link AqlParser#invokeExpr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
